...
public class SqrtTests
{
    ...
    public void Constructor_SetsProperties()
    {
        ...
        Assert.Equal("Sqrt", indicator.Name);
    ...
    public void Calculate_TSeries_MatchesStreaming()
    {
        ...
        // Batch
        var batch = Sqrt.Calculate(source);
    ...
    public void Calculate_Span_MatchesTSeries()
    {
        ...
        // TSeries batch
        var batchResult = Sqrt.Calculate(source);
    ...
    public void Calculate_Span_ValidatesArguments()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            ...
            Sqrt.Calculate(ReadOnlySpan<double>.Empty, output);
        });
        ...
        Assert.Throws<ArgumentException>(() =>
        {
            ...
            Sqrt.Calculate(source, output);
        });
    }

    [Fact]
    public void SqrtSquared_ReturnsOriginal()
    {
        var sqrt = new Sqrt();
        var time = DateTime.UtcNow;
        double value = 25.0;
    ...
    [Fact]
    public void Sqrt_AlwaysPositive()
    {
        var indicator = new Sqrt();
        var time = DateTime.UtcNow;
