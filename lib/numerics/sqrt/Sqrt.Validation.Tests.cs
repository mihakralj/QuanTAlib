...
/// <summary>
/// SQRT validation tests - validates against Math.Sqrt (standard library)
/// </summary>
public class SqrtValidationTests
{
    private const double Tolerance = 1e-14;

    [Fact]
    public void Sqrt_Batch_MatchesMathSqrt()
    {
        int count = 100;
        ...
        var result = Sqrt.Calculate(source);
    ...
    [Fact]
    public void Sqrt_Streaming_MatchesMathSqrt()
    {
        int count = 100;
    ...
    [Fact]
    public void Sqrt_Span_MatchesMathSqrt()
    {
        int count = 100;
    ...
    [Fact]
    public void Sqrt_KnownPerfectSquares()
    {
        var indicator = new Sqrt();
    ...
    [Fact]
    public void Sqrt_KnownIrrationalResults()
    {
        var indicator = new Sqrt();
        var time = DateTime.UtcNow;
    ...
    [Fact]
    public void Sqrt_InverseOfSquare()
    {
        ...
        var sqrtResult = Sqrt.Calculate(squared);
    ...
    [Fact]
    public void Sqrt_PowerRelationship()
    {
        // sqrt(x) = x^0.5
