...
/// <summary>
/// EXP validation tests - validates against Math.Exp (standard library)
/// </summary>
public class ExpValidationTests
{
    private const double Tolerance = 1e-14;

    [Fact]
    public void Exp_Batch_MatchesMathExp()
    {
        int count = 100;
        ...
        var result = Exp.Calculate(logSource);
    ...
    [Fact]
    public void Exp_Streaming_MatchesMathExp()
    {
        int count = 100;
    ...
    [Fact]
    public void Exp_Span_MatchesMathExp()
    {
        int count = 100;
    ...
    [Fact]
    public void Exp_KnownIdentities()
    {
        var indicator = new Exp();
    ...
    public void Exp_InverseOfLog()
    {
        ...
        var logResult = Log.Calculate(source);
        var expResult = Exp.Calculate(logResult);
