...
public class LinearTests
{
    ...
    [Fact]
    public void Linear_Constructor_DefaultParameters()
    {
        var linear = new Linear();
        Assert.Equal("Linear(1,0)", linear.Name);
        Assert.Equal(0, linear.WarmupPeriod);
        Assert.True(linear.IsHot);
    }

    [Fact]
    public void Linear_Constructor_CustomParameters()
    {
        var linear = new Linear(slope: 2.5, intercept: -10.0);
        Assert.Equal("Linear(2.5,-10)", linear.Name);
    }

    [Fact]
    public void Linear_Constructor_InvalidSlope_ThrowsException()
    {
        Assert.Throws<ArgumentException>(() => new Linear(slope: double.NaN));
        Assert.Throws<ArgumentException>(() => new Linear(slope: double.PositiveInfinity));
        Assert.Throws<ArgumentException>(() => new Linear(slope: double.NegativeInfinity));
    }

    [Fact]
    public void Linear_Constructor_InvalidIntercept_ThrowsException()
    {
        Assert.Throws<ArgumentException>(() => new Linear(slope: 1.0, intercept: double.NaN));
        Assert.Throws<ArgumentException>(() => new Linear(slope: 1.0, intercept: double.PositiveInfinity));
    }

    [Fact]
    public void Linear_Identity_ReturnsInputValue()
    {
        var linear = new Linear(slope: 1.0, intercept: 0.0);
    ...
    [Fact]
    public void Linear_ScaleOnly_MultipliesValue()
    {
        var linear = new Linear(slope: 2.0, intercept: 0.0);
    ...
    [Fact]
    public void Linear_OffsetOnly_AddsValue()
    {
        var linear = new Linear(slope: 1.0, intercept: 25.0);
    ...
    [Fact]
    public void Linear_ScaleAndOffset_AppliesBoth()
    {
        var linear = new Linear(slope: 2.0, intercept: 10.0);
    ...
    [Fact]
    public void Linear_NegativeSlope_InvertsValue()
    {
        var linear = new Linear(slope: -1.0, intercept: 0.0);
        var input = new TValue(DateTime.UtcNow, 50.0);
        var result = linear.Update(input);
    ...
    [Fact]
    public void Linear_ZeroSlope_ReturnsIntercept()
    {
        var linear = new Linear(slope: 0.0, intercept: 42.0);
    ...
    [Fact]
    public void Linear_Update_HandlesNaN()
    {
        var linear = new Linear(slope: 2.0, intercept: 5.0);
    ...
    [Fact]
    public void Linear_Update_HandlesInfinity()
    {
        var linear = new Linear(slope: 2.0, intercept: 5.0);
    ...
    [Fact]
    public void Linear_IsNew_True_AdvancesState()
    {
        var linear = new Linear(slope: 2.0, intercept: 0.0);
    ...
    [Fact]
    public void Linear_IsNew_False_CorrectsSameBar()
    {
        var linear = new Linear(slope: 2.0, intercept: 0.0);
        var time = DateTime.UtcNow;
    ...
    [Fact]
    public void Linear_Reset_ClearsState()
    {
        var linear = new Linear(slope: 2.0, intercept: 5.0);
    ...
    [Fact]
    public void Linear_TSeries_Update()
    {
        var linear = new Linear(slope: 2.0, intercept: 10.0);
    ...
    [Fact]
    public void Linear_Static_Calculate_TSeries()
    {
        var series = new TSeries();
        var time = DateTime.UtcNow;
        ...
        var result = Linear.Calculate(series, slope: 0.5, intercept: 5.0);
    ...
    [Fact]
    public void Linear_Static_Calculate_Span()
    {
        double[] source = [10.0, 20.0, 30.0, 40.0, 50.0];
        double[] output = new double[5];

        Linear.Calculate(source, output, slope: 2.0, intercept: -5.0);
    ...
    [Fact]
    public void Linear_Static_Calculate_Span_ValidationErrors()
    {
        double[] source = [1.0, 2.0, 3.0];
        double[] output = new double[3];

        Assert.Throws<ArgumentException>(() => Linear.Calculate([], output));
        Assert.Throws<ArgumentException>(() => Linear.Calculate(source, new double[2]));
        Assert.Throws<ArgumentException>(() => Linear.Calculate(source, output, slope: double.NaN));
        Assert.Throws<ArgumentException>(() => Linear.Calculate(source, output, intercept: double.PositiveInfinity));
    }

    [Fact]
    public void Linear_Chaining_Constructor()
    {
        var source = new TSeries();
        var linear = new Linear(source, slope: 3.0, intercept: 1.0);
    ...
    [Fact]
    public void Linear_Batch_Stream_Span_Consistency()
    {
        ...
        // Batch
        var batchResult = Linear.Calculate(series, slope, intercept);

        // Stream
        var streamIndicator = new Linear(slope, intercept);
        ...
        Linear.Calculate(series.Values, spanOutput, slope, intercept);
