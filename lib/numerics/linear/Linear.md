...
```csharp
var toDecimal = new Linear(slope: 0.01, intercept: 0.0);
...
var normalizer = new Linear(slope: 1.0 / baseline, intercept: -1.0);
...
var transform = new Linear(m, b);
var inverse = new Linear(1.0 / m, -b / m);
...
```csharp
var scale = new Linear(2.0, 0.0);
var offset = new Linear(scale, 1.0, 10.0);  // Chain: scale then add 10
