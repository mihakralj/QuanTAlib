...
/// <summary>
/// Validation tests for MUL against TA-Lib's Mult function.
/// </summary>
public class MulValidationTests
{
    private readonly GBM _gbmA = new(sigma: 0.5, mu: 0.0, seed: 102);
    private readonly GBM _gbmB = new(sigma: 0.3, mu: 0.0, seed: 202);
    private const double Tolerance = 1e-6;

    [Fact]
    public void Mul_MatchesTalib_Batch()
    {
        ...
        var qResult = Mul.Batch(a, b);

        double[] tOutput = new double[a.Count];
        var retCode = TALib.Functions.Mult<double>(a.Values, b.Values, 0..^0, tOutput, out var outRange);
    ...
    [Fact]
    public void Mul_MatchesTalib_Streaming()
    {
