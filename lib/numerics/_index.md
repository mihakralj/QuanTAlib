...
| [ADD](add/Add.md) | Element-wise Addition | Sum of two time-aligned streams: a + b. |
...
| [DIV](div/Div.md) | Element-wise Division | Quotient of two time-aligned streams: a / b; 0.0 near zero denominator. |
...
| [LAG](lag/Lag.md) | Value Delay | Republishes the input from n bars ago: x[t-n]. |
...
| [MUL](mul/Mul.md) | Element-wise Multiplication | Product of two time-aligned streams: a * b. |
...
| [SUB](sub/Sub.md) | Element-wise Subtraction | Difference of two time-aligned streams: a - b. |
