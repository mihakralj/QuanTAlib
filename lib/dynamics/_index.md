...
| :--- | :--- | :--- |
| [ADX](adx/Adx.md) | Average Directional Index | Measures trend strength, regardless of direction (uses +DI and -DI). |
| [ADXR](adxr/Adxr.md) | Average Directional Movement Rating | Smoothed version of ADX, often used in conjunction with ADX for signals. |
| ALLIGATOR | Williams Alligator | Uses three smoothed moving averages (Jaw, Teeth, Lips) to identify trends and trading ranges. |
| [AMAT](amat/Amat.md) | Archer Moving Averages Trends | Trend identification using multiple EMAs; requires alignment of fast/slow EMAs and directional movement. |
| [AROON](aroon/Aroon.md) | Aroon | Identifies trend direction and strength by measuring time since price recorded new highs/lows. |
| [AROONOSC](aroonosc/AroonOsc.md) | Aroon Oscillator | Single-line oscillator (Aroon Up - Aroon Down); positive = bullish, negative = bearish. |
...
| [DMX](dmx/Dmx.md) | Jurik Directional Movement Index | Smoothed Bipolar Directional Movement Index (DMI). |
...
| [SUPER](super/Super.md) | SuperTrend | ATR-based trend following with dynamic support/resistance; green line below price = bullish, red above = bearish. |
