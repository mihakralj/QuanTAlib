...
public sealed class VarianceVectorTests
{
    private static readonly int[] Periods = [2, 3, 4, 5, 8, 16];

    private readonly ITestOutputHelper _output;

    public VarianceVectorTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    private void Verify(double[] source, int period, bool isPopulation)
    {
        ...
        Variance.CalculateScalarCore(source, scalar, period, isPopulation);
        Variance.CalculateVectorCore(source, vector, period, isPopulation);
