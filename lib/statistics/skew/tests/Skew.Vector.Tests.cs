...
public sealed class SkewVectorTests
{
    private static readonly int[] Periods = [3, 4, 5, 8, 16];

    private readonly ITestOutputHelper _output;

    public SkewVectorTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    private void Verify(double[] source, int period, bool isPopulation)
    {
        ...
        Skew.CalculateScalarCore(source, scalar, period, isPopulation);
        Skew.CalculateVectorCore(source, vector, period, isPopulation);
