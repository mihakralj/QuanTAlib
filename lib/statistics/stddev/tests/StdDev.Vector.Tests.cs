...
public sealed class StdDevVectorTests
{
    private static readonly int[] Periods = [2, 3, 4, 5, 8, 16];

    private readonly ITestOutputHelper _output;

    public StdDevVectorTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    private void Verify(double[] source, int period, bool isPopulation)
    {
        ...
        StdDev.CalculateScalarCore(source, scalar, period, isPopulation);
        StdDev.CalculateVectorCore(source, vector, period, isPopulation);
