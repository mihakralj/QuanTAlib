<<<<<<< Updated upstream:QuantLib/Series/HMA_Series.cs
﻿using System;
namespace QuantLib;
...
public class HMA_Series : TSeries
{
    ...
    public new void Add((System.DateTime t, double v) data, bool update = false)
    {
        ...
        (System.DateTime t, double v) result = (data.t, (this.Count < this._p - 1 && this._NaN) ? double.NaN : _hma);
        if (update)
        {
            base[base.Count - 1] = result;
        }
...
>>>>>>> Stashed changes:Algos/HMA_Series.cs
