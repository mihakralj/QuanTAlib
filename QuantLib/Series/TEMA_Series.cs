<<<<<<< Updated upstream:QuantLib/Series/TEMA_Series.cs
﻿namespace QuantLib;
...
public class TEMA_Series : TSeries {
  ...
  public new void Add((System.DateTime t, double v)data, bool update = false) {
    ...
    double _ema3 = System.Double.IsNaN(this._lastema3)
                       ? _ema2
                       : _ema2 * this._k + this._lastema3 * this._k1m;
    ...
    (System.DateTime t, double v) result =
        (data.t, (this.Count < this._p - 1 && this._NaN) ? double.NaN : _tema);
    if (update) {
...
>>>>>>> Stashed changes:Algos/TEMA_Series.cs
