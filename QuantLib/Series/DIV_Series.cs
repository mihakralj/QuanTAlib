<<<<<<< Updated upstream:QuantLib/Series/DIV_Series.cs
...
public class DIV_Series : TSeries
{
    ...
    {
        (System.DateTime t, double v) result = ((d1.t > d2.t) ? d1.t : d2.t, (d2.v > double.Epsilon) ? d1.v / d2.v : double.PositiveInfinity);
        if (update)
        {
            base[base.Count - 1] = result;
        }
    ...
    {
        (System.DateTime t, double v) result = (d1.t, (dd > double.Epsilon) ? d1.v / dd : double.PositiveInfinity);
        if (update)
        {
            base[base.Count - 1] = result;
        }
    ...
    {
        (System.DateTime t, double v) result = (d1.t, (d1.v > double.Epsilon) ? dd / d1.v : double.PositiveInfinity);
        if (update)
        {
            base[base.Count - 1] = result;
        }
...
>>>>>>> Stashed changes:Algos/DIV_Series.cs
