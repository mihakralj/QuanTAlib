<<<<<<< Updated upstream:QuantLib/Series/DEMA_Series.cs
﻿namespace QuantLib;
...
public class DEMA_Series : TSeries
{
    ...
    public new void Add((System.DateTime t, double v) data, bool update = false)
    {
        ...
        (System.DateTime t, double v) result = (data.t, (this.Count < this._p - 1 && this._NaN) ? double.NaN : _dema);
        if (update)
        {
            base[base.Count - 1] = result;
        }
...
>>>>>>> Stashed changes:Algos/DEMA_Series.cs
