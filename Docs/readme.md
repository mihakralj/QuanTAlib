...
[![.NET library build/test](https://github.com/mihakralj/QuanTAlib/actions/workflows/main_automation.yml/badge.svg)](https://github.com/mihakralj/QuanTAlib/actions/workflows/main_automation.yml)
