...
public class JMA_chart : Indicator
    ...
    public JMA_chart() : base()
    {
        ...
        AddLineSeries("JMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        jma = new(source: this.source, period: this.Period, phase: this.Phase, useNaN: true);
        /////////////////////////////////////////////////////////

        GetHistory(Period+65, bars);
        ShortName = "JMA (" + SourceStr(DataSource) + ", " + Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = jma[jma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (debug)
        {
            ...
            gr.DrawString($"Bars on chart: {jma.Count - History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)jma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(jma[jma.Count - 1].t - jma[History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
