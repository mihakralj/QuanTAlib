...
public class TEMA_chart : Indicator
{
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.tema = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "TEMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }

    protected void OnNewData(bool update = false)
    {
        /////////////////////////////////////////////////////////
        this.tema.Add(update);
        /////////////////////////////////////////////////////////
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.tema[this.tema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.tema.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.tema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.tema[this.tema.Count - 1].t - this.tema[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
