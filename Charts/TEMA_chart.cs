...
public class TEMA_chart : Indicator
    ...
    public TEMA_chart() : base()
    {
        ...
        Description = "Triple Exponential Moving Average description";

        AddLineSeries("TEMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        tema = new(source: this.source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        GetHistory(Period, bars);
        ShortName = "TEMA (" + SourceStr(DataSource) + ", " + Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = tema[tema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (debug)
        {
            ...
            gr.DrawString($"Bars on chart: {tema.Count - History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)tema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(tema[tema.Count - 1].t - tema[History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
