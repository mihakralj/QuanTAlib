...
public class RMA_chart : Indicator
{
    ...
    private QuantLib.RMA_Series rma;

    public RMA_chart() : base()
    {
        this.SeparateWindow = false;
        this.Name = "RMA - Wilder Moving Average";
        this.Description = "Wilder Moving Average description";

        this.AddLineSeries("RMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.rma = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "RMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.rma[this.rma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.rma.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.rma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.rma[this.rma.Count - 1].t - this.rma[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
