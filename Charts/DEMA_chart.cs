...
public class DEMA_chart : Indicator
{
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.dema = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "DEMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }

    protected void OnNewData(bool update = false)
    {
        /////////////////////////////////////////////////////////
        this.dema.Add(update);
        /////////////////////////////////////////////////////////
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.dema[this.dema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.dema.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.dema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.dema[this.dema.Count - 1].t - this.dema[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
