...
public class DEMA_chart : Indicator
    ...
    public DEMA_chart() : base()
    {
        ...
        Description = "Double Exponential Moving Average description";

        AddLineSeries("DEMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        dema = new(source: this.source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        GetHistory(Period, bars);
        ShortName = "DEMA (" + SourceStr(DataSource) + ", " + Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = dema[dema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (debug)
        {
            ...
            gr.DrawString($"Bars on chart: {dema.Count - History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)dema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(dema[dema.Count - 1].t - dema[History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
