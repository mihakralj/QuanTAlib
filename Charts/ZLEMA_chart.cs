...
public class ZLEMA_chart : Indicator
    ...
    private QuantLib.ZLEMA_Series zlema;

    public ZLEMA_chart() : base()
    {
        SeparateWindow = false;
        Name = "ZLEMA - Zero Lag Exponential Moving Average";
        Description = "Zero Lag Exponential Moving Average description";

        AddLineSeries("ZLEMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        zlema = new(source: this.source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        GetHistory(Period, bars);
        ShortName = "ZLEMA (" + SourceStr(DataSource) + ", " + Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = zlema[zlema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (debug)
        {
            ...
            gr.DrawString($"Bars on chart: {zlema.Count - History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)zlema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(zlema[zlema.Count - 1].t - zlema[History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
