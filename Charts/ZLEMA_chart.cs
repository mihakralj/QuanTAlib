...
public class ZLEMA_chart : Indicator
{
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.zlema = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "ZLEMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }

    protected void OnNewData(bool update = false)
    {
        /////////////////////////////////////////////////////////
        this.zlema.Add(update);
        /////////////////////////////////////////////////////////
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.zlema[this.zlema.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.zlema.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.zlema:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.zlema[this.zlema.Count - 1].t - this.zlema[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
