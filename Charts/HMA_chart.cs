...
public class HMA_chart : Indicator
{
    ...
    private QuantLib.HMA_Series hma;

    public HMA_chart() : base()
    {
        this.SeparateWindow = false;
        this.Name = "HMA - Hull Moving Average";
        this.Description = "Hull Moving Average description";

        this.AddLineSeries("HMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.hma = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "HMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.hma[this.hma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.hma.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.hma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.hma[this.hma.Count - 1].t - this.hma[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
