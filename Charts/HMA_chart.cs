...
public class HMA_chart : Indicator
    ...
    public HMA_chart() : base()
    {
        ...
        Description = "Hull Moving Average description";

        AddLineSeries("HMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        hma = new(source: this.source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        GetHistory(Period, bars);
        ShortName = "HMA (" + SourceStr(DataSource) + ", " + Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = hma[hma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (debug)
        {
            ...
            gr.DrawString($"Bars on chart: {hma.Count - History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)hma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(hma[hma.Count - 1].t - hma[History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
