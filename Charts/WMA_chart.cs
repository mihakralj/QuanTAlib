...
public class WMA_chart : Indicator
{
    ...
    public WMA_chart() : base()
    {
        ...
        this.AddLineSeries("WMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.wma = new(source: source, period: this.Period, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period, this.bars);
        this.ShortName = "WMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.wma[this.wma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.wma.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.wma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.wma[this.wma.Count - 1].t - this.wma[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
