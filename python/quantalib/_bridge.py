...
HAS_UO = _bind("qtl_uo", [_dp, _ci, _dp, _ci])
HAS_SRSI = _bind("qtl_srsi", [_dp, _ci, _dp, _ci, _ci])
HAS_HHLLS = _bind("qtl_hhlls", [_dp, _dp, _ci, _dp, _dp, _ci])
HAS_STMACD = _bind("qtl_stmacd", [_dp, _dp, _dp, _ci, _dp, _dp, _ci, _ci, _ci, _ci])
...
HAS_OBVM = _bind("qtl_obvm", [_dp, _dp, _ci, _dp, _dp, _ci, _ci])
...
HAS_HTPHANA = _bind("qtl_htphana", [_dp, _ci, _dp, _ci])
