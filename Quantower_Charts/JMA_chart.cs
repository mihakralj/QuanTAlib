...
public class JMA_chart : Indicator
{
    ...
    [InputParameter("Phase", 2, -100, 100, 1, 1)]
    ...
    private QuantLib.JMA_Series jma;
    ...
    public JMA_chart()
    {
        ...
        this.AddLineSeries("JMA", Color.Yellow, 2, LineStyle.Solid);
    }
    ...
    protected override void OnInit()
    {
        ...
        /////////////////////////////////////////////////////////
        this.jma = new(source: source, period: this.Period, phase: this.Phase, useNaN: true);
        /////////////////////////////////////////////////////////

        this.GetHistory(this.Period + 65, this.bars);
        this.ShortName = "JMA (" + this.SourceStr(this.DataSource) + ", " + this.Period + ")";
    }
    ...
    protected override void OnUpdate(UpdateArgs args)
    {
        ...
        /////////////////////////////////////////////////////////
        double result = this.jma[this.jma.Count - 1].v;
        /////////////////////////////////////////////////////////
    ...
    public override void OnPaintChart(PaintChartEventArgs args)
    {
        ...
        if (this.debug)
        {
            ...
            gr.DrawString($"Bars on chart: {this.jma.Count - this.History.Count}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 45);
            gr.DrawString($"Last value: {(double)this.jma:f3}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 65);
            gr.DrawString($"Timespan: {(this.jma[this.jma.Count - 1].t - this.jma[this.History.Count - 1].t).ToString()}", new Font("Tahoma", 10), Brushes.Gray, 3, y + 80);
        }
    }
